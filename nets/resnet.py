...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        #self.conv1 = nn.Conv2d(3, self.inplanes, kernel_size=3, stride=1, padding=1, bias=False) #for cifar100
        ...
        #self.fc = nn.Linear(512 * block.expansion, num_classes) #for cifar
