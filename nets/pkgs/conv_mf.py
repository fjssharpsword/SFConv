...
#https://github.com/microsoft/fnl_paper/blob/main/deficient-efficient/models/decomposed.py
...
class TnTorchConv2d(nn.Conv2d):
    ...
    def forward(self, x):
        ...
        return F.conv2d(out, weight.cuda(), self.bias, self.stride, self.padding,
