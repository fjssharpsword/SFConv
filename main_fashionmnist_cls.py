# encoding: utf-8
"""
Training implementation for Fashion-MNIST dataset.  
Author: Jason.Fang
...
max_epoches = 50
batch_size = 256
CKPT_PATH = '/data/pycode/LungCT3D/ckpt/fashionmnist_resnet_sfconv.pkl'
def Train():
    print('********************load data********************')
    ...
    for epoch in range(max_epoches):
        ...
        log_writer.add_scalars('CrossEntropyLoss/Fashion-MNIST-ResNet', {'SFConv':np.mean(loss_train)}, epoch+1)
